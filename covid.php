        ...
        <div class="container">
          <div class="row">
            <div class="major-caousel js-carousel-1 owl-carousel">
              ...
              <div>
                <div class="media d-block media-custom text-center">
                  <a href="covid_ind/Tracker - Odisha/index.php"><img src="img/sik/map1.jpg" alt="Image Placeholder" class="img-fluid"></a>
                 
                  <div class="media-body" style="background-color: #121212">
                    <h3 class="mt-0 text-white">SIKKIM ANALYSIS</h3>
          ...
          <div class="col-md-5 mb-5">
            ...
            <div>
              ...
              <ul class="list-unstyled footer-link">
                <li class="d-block">
                  <span class="d-block text-grey"style="color: sienna">Address:</span>
                  <span style="color: sienna">34 Street Name, Sikkim, India</span></li>
                <li class="d-block" ><span class="d-block text-grey"style="color: sienna" >Phone:</span><span>+1 242 4942 290</span></li>
                <li class="d-block"><span class="d-block text-grey"style="color: sienna">Email:</span><span>info@esikkim.com</span></li>
              </ul>
            </div>
          </div>
