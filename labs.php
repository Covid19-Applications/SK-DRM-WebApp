...
<!-- ======= Features Section ======= -->
        ...
        <ul class="nav nav-tabs row d-flex">
          ...
          <li class="nav-item col-3" data-aos="zoom-in" data-aos-delay="300">
            <a class="nav-link" data-toggle="tab" href="#tab-4">
              ...
              <h4 class="d-none d-lg-block">COVID SIKKIM UPDATES</h4>
            </a>
          </li>
        </ul>
          ...
          <div class="tab-pane active show" id="tab-1">
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                ...
                <p class="font-italic">
                  The following data provides data on testing done at centers in Sikkim for the treatment & diagnosis of COVID-19.
                </p>
                <ul>
 ...
 <button id="mapsbtn">GO TO CHATBOT</button></a>
          ...
          <div class="tab-pane" id="tab-4">
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                <h3>Clinics  & Testing centers in SIKKIM</h3>
                ...
                <ul>
                  <li><i class="ri-check-double-line"></i> <n2 >SIKKIM CONFIRMED<h2>
                  <n2 id="dc"><h2></li>
                  <li><i class="ri-check-double-line"></i>  <n2>SIKKIM RECOVERED<h2>
                  <n2 id="dr"><h2></li>
                  <li><i class="ri-check-double-line"></i>  <n2>SIKKIM DEATHS<h2>
                  <n2 id="dd"><h2></li>
                </ul>
              </div>
              <div class="col-lg-6 order-1 order-lg-2 text-center">
...
Array.prototype.sum = function (prop) {
    ...
    var DelhiConfirmed = covid_data[30].districtData.sum("confirmed");
    document.getElementById("dc").innerHTML = DelhiConfirmed
    var DelhiDeceased = covid_data[30].districtData.sum("deceased");
    document.getElementById("dd").innerHTML = DelhiDeceased
        var DelhiRecovered = covid_data[30].districtData.sum("deceased");
...
<div class="container table-responsive">
  ...
  <h1 style="text-align: center;">DAILY-RECORDS OF TESTING IN SIKKIM</h1>
