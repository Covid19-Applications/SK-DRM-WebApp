        ...
        <div class="container-fluid">
          <div class="row" data-aos="fade">
            ...
            <div class="container" style="position: center;">
              <CENTER>
<img class="responsive" src="img/sik/p.png">
</CENTER>
</div>
                        ...
                        <div class="container box_1170">
                            ...
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25" style="text-align: center;">Emergency Speciality Hospitals</h2>
                                    <?php
                                  $query = "SELECT * FROM healthcare WHERE state='sikkim'";
...
<div class="container table-responsive">
  <h1 style="text-align: center;">HEALTH-CARE CENTERS IN SIKKIM</h1>
  <br><br>
  <!-- <CENTER>
